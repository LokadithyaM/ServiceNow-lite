"use client";
import { sendIncident } from "@/lib/socket";
...
export default function Form() {
  ...
  const [formData, setFormData] = useState({
    shortDescription: "", // Short summary of the issue
    description: "", // Detailed description of the issue
    priority: "", // Priority level
    state: "", // Current state of the ticket
    category: "", // Issue category
    assignedTo: "", // Person assigned to resolve the issue
    assignmentGroup: "",
  });
      ...
      <div className="border-2 border-white bg-white p-8 rounded-lg w-full">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
          ...
          <FormControl fullWidth>
            ...
            <Select name="assignmentGroup" value={formData.assignmentGroup} onChange={handleChange}>
              <MenuItem value="group1">developer</MenuItem>
              <MenuItem value="group2">analyst</MenuItem>
              <MenuItem value="group3">manager</MenuItem>
              <MenuItem value="group4">webmaster</MenuItem>
            </Select>
          </FormControl>
        ...
        <div className="mb-4">
          <TextField
            ...
            helperText={errors.shortDescription ? "This field is required" : ""}
          />
        </div>
